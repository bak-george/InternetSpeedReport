<x-layout>
    ...
    <section class="mx-auto max-w-7xl sm:px-6 lg:px-8 mt-5">
        <button type="button" class="relative block w-full rounded-lg border-2 border-dashed border-purple p-12 text-center">
            <svg class="mx-auto size-12 text-purple" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v20c0 4.418 7.163 8 16 8 1.381 0 2.721-.087 4-.252M8 14c0 4.418 7.163 8 16 8s16-3.582 16-8M8 14c0-4.418 7.163-8 16-8s16 3.582 16 8m0 0v14m0-4c0 4.418-7.163 8-16 8S8 28.418 8 24m32 10v6m0 0v6m0-6h6m-6 0h-6" />
            </svg>
            <span class="mt-2 block text-sm text-purple ubuntu-regular">No Data</span>
        </button>
    </section>
    @endif
</x-layout>
